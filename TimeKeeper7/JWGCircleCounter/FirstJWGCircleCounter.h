...
@protocol FirstJWGCircleCounterDelegate;

@interface FirstJWGCircleCounter : UIView

/// The receiver of all counter delegate callbacks.
@property (nonatomic, strong) id<FirstJWGCircleCounterDelegate> delegate;
...
@protocol FirstJWGCircleCounterDelegate <NSObject>
 ...
 */
@optional
- (void)circleCounterTimeDidExpire:(FirstJWGCircleCounter *)circleCounter;
