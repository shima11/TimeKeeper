...
@implementation SetJWGCircleCounter
...
//    endAngle1 = (M_PI*3/2-((CGFloat)numAdjustedSecondsCompleted + 1.0f) /
...
- (void)update {
    if (self.isRunning) {
       ...
       if (numAdjustedSecondsCompleted >= numAdjustedSecondsTotal*self.radian) {
    
            // finished
            numAdjustedSecondsCompleted = numAdjustedSecondsTotal*self.radian - 1;
            [self stop];
            _didFinish = YES;
