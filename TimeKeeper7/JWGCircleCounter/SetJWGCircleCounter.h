...
@protocol SetJWGCircleCounterDelegate;

@interface SetJWGCircleCounter : UIView

/// The receiver of all counter delegate callbacks.
@property (nonatomic, strong) id<SetJWGCircleCounterDelegate> delegate;
...
@protocol SetJWGCircleCounterDelegate <NSObject>
 ...
 */
@optional
- (void)circleCounterTimeDidExpire:(SetJWGCircleCounter *)circleCounter;
